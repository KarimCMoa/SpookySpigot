...
public interface Server extends PluginMessageRecipient {
    ...
    void initPSpigot(PluginLoadOrder o);
    ...
    boolean isPlayerFromTab();

    boolean isActivationEntities();

    boolean isActivationMobs();

    float getPotionOffset();

    void setPotionOffset(float f);

    float getPotionSpeed();

    void setPotionSpeed(float f);

    float getPotionMultiplier();

    void setPotionMultiplier(float f);

    void setDefaultPotions();

    int getHitDetection();

    void setHitDetection(int i);

    boolean isProtocolSupport();

    void setProtocolSupport(boolean protocolSupport);

    void savePSpigot();

    void setInConfig(String path, Object val);

    void getInConfig(String path);
    // Paper end
    ...
    KnockBack getActiveKnockback();

    void setActiveKnockback(KnockBack knockback);

    KnockBack getProfileByName(String name);

    Set<KnockBack> getProfiles();
    ...
    void setFirstColor(String s);

    void setSecondColor(String s);

    String getThirdColor();

    void setThirdColor(String s);

    boolean isThirdColor();

    void setThirdColor(boolean thirdColor);

    String getNegativeColor();

    void setNegativeColor(String s);

    String getPositiveColor();

    void setPositiveColor(String s);

    String getSeparatorColor();

    void setSeparatorColor(String s);
