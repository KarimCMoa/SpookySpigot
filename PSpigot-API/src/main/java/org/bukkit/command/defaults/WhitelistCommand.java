...
public class WhitelistCommand extends VanillaCommand {
    ...
    public boolean execute(CommandSender sender, String currentAlias, String[] args) {
        ...
        sender.sendMessage(Bukkit.getServer().getNegativeColor() + "Correct command usage:\n" + usageMessage);
        return false;
    }

    private boolean badPerm(CommandSender sender, String perm) {
        if (!sender.hasPermission("bukkit.command.whitelist." + perm)) {
            sender.sendMessage(Bukkit.getServer().getNegativeColor() + "You do not have permission to perform this action.");
            return true;
        }
