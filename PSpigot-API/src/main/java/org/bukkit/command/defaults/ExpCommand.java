        ...
        if (args.length > 0) {
            ...
            if (player != null) {
                if (isLevel) {
                    ...
                    if (isTaking) {
                        sender.sendMessage(Bukkit.getServer().getNegativeColor() + "Taking experience can only be done by levels, cannot give players negative experience points");
                        return false;
                    } else {
