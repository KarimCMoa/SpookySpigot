...
public class EffectCommand extends VanillaCommand {
    ...
    public boolean execute(CommandSender sender, String commandLabel, String[] args) {
        ...
        if (player == null) {
            sender.sendMessage(Bukkit.getServer().getNegativeColor() + String.format("Player, %s, not found", args[0]));
            return true;
        }
        ...
        if (effect == null) {
            sender.sendMessage(Bukkit.getServer().getNegativeColor() + String.format("Effect, %s, not found", args[1]));
            return true;
        }
