    ...
    public boolean execute(CommandSender sender, String currentAlias, String[] args) {
        ...
        if (player != null) {
            ...
            if (args.length > 1 && !(args[1].equals("-1"))) {
                ...
                if (material == null) {
                    sender.sendMessage(Bukkit.getServer().getNegativeColor() + "There's no item called " + args[1]);
                    return false;
                }
            ...
            sender.sendMessage(Bukkit.getServer().getNegativeColor() + "Please provide a player!");
        } else {
            sender.sendMessage(Bukkit.getServer().getNegativeColor() + "Can't find player " + args[0]);
        }
