...
public class HoverAction {
    ...
    public HoverAction(ItemStack itemstack) {
        ...
        net.minecraft.server.ItemStack nmsitemstack = CraftItemStack.asNMSCopy((ItemStack)itemstack);
    ...
    public ItemStack getItemStack() {
        ...
        try {
            return CraftItemStack.asCraftMirror((net.minecraft.server.ItemStack)net.minecraft.server.ItemStack.createStack((NBTTagCompound)MojangsonParser.parse((String)this.value)));
        }
