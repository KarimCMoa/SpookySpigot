        ...
        if (element.isJsonObject()) {
            ...
            if (jsonObject.has("text")) {
                ...
                if (jsonObject.has("with")) {
                    ...
                    component = new TranslateComponent(translate, new Object[0]);
                }
            ...
            if (jsonObject.has("extra")) {
                ...
                for (int i = 0; i < siblingsArray.size(); ++i) {
                    component.addSibling(this.deserialize(siblingsArray.get(i), type, ctx));
                }
            }
            if (jsonObject.has("insertion")) {
                component.setClickInsertion(jsonObject.getAsJsonPrimitive("insertion").getAsString());
            }
            component.setModifier((Modifier)ctx.deserialize(element, Modifier.class));
            component.setClickAction((ClickAction)ctx.deserialize(element, ClickAction.class));
            component.setHoverAction((HoverAction)ctx.deserialize(element, HoverAction.class));
            return component;
        }
        throw new JsonParseException("Don't know how to turn " + element.toString() + " into a Component");
    }
