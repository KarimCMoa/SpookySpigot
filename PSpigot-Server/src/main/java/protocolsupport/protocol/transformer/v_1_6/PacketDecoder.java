...
implements IPacketDecoder {
    ...
    public PacketDecoder(ProtocolVersion version) {
        try {
            ...
            this.dataRemapperRegistry.register(EnumProtocol.HANDSHAKING, 254, Ping.class);
            ...
            this.dataRemapperRegistry.register(EnumProtocol.PLAY, 27, SteerVehicle.class);
    ...
    public void decode(ChannelHandlerContext ctx, ByteBuf input, List<Object> list) throws Exception {
        block7 : {
            ...
            try {
                short packetId = this.buffer.readUnsignedByte();
                ...
                RecyclableCollection<Packet<?>> collection = (RecyclableCollection<Packet<?>>) packetTransformer.toNative();
                try {
