 ...
 *  org.bukkit.craftbukkit.util.Waitable
...
public class PlayerLookupUUID {
    ...
    private void fireLoginEvents() throws Exception {
        ...
        for (Property property : propertymap.values()) {
            properties.add(new PlayerPropertiesResolveEvent.ProfileProperty(property.getName(), property.getValue(), property.getSignature()));
        }
