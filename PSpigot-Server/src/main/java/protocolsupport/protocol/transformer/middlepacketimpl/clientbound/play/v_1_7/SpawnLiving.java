...
extends MiddleSpawnLiving<RecyclableCollection<PacketData>> {
    ...
    public RecyclableCollection<PacketData> toData(ProtocolVersion version) {
        ...
        serializer.writeBytes(DataWatcherSerializer.encodeData(version, WatchedDataRemapper.transform(this.wentity, (TIntObjectMap<DataWatcherObject>)this.metadata, version)));
