...
extends MiddleEntityMetadata<RecyclableCollection<PacketData>> {
    ...
    public RecyclableCollection<PacketData> toData(ProtocolVersion version) {
        ...
        serializer.writeBytes(DataWatcherSerializer.encodeData(version, WatchedDataRemapper.transform(this.storage.getWatchedEntity(this.entityId), (TIntObjectMap<DataWatcherObject>)this.metadata, version)));
