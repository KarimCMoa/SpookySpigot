...
extends MiddleSpawnNamed<RecyclableCollection<PacketData>> {
    ...
    public RecyclableCollection<PacketData> toData(ProtocolVersion version) {
        ...
        serializer.writeBytes(DataWatcherSerializer.encodeData(version, WatchedDataRemapper.transform(this.wplayer, (TIntObjectMap<DataWatcherObject>)this.metadata, version)));
