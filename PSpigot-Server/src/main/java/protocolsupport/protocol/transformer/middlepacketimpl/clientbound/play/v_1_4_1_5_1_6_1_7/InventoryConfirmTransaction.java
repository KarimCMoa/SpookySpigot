...
public class InventoryConfirmTransaction
extends MiddleInventoryConfirmTransaction<RecyclableCollection<PacketData>> {
    @Override
    public RecyclableCollection<PacketData> toData(ProtocolVersion version) throws IOException {
        ...
        serializer.writeBoolean(this.accepted);
