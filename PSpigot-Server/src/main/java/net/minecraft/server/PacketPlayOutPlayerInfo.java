...
public class PacketPlayOutPlayerInfo implements Packet<PacketListenerPlayOut> {
    ...
    private List<PacketPlayOutPlayerInfo.PlayerInfoData> b = Lists.newArrayList();
    ...
    public PacketPlayOutPlayerInfo(PacketPlayOutPlayerInfo.EnumPlayerInfoAction packetplayoutplayerinfo_enumplayerinfoaction, EntityPlayer... aentityplayer) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            this.b.add(new PacketPlayOutPlayerInfo.PlayerInfoData(entityplayer.getProfile(), 0, entityplayer.playerInteractManager.getGameMode(), entityplayer.getPlayerListName()));
        }
    ...
    public EnumPlayerInfoAction getA() {
        return this.a;
    }

    public List<PlayerInfoData> getB() {
        return this.b;
    }

    public void setA(EnumPlayerInfoAction a) {
        this.a = a;
    }

    public void setB(List<PlayerInfoData> b) {
        this.b = b;
    }
