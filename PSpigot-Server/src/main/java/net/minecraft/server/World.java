...
import eu.poliks.pspigot.util.OptimizedRemoveUtil;
...
public abstract class World implements IBlockAccess {
    ...
    public void tickEntities() {
        ...
        if (!this.c.isEmpty()) {
            // PSpigot start - use OptimizedRemoveUtil
    ...
    public void entityJoinedWorld(Entity entity, boolean flag) {
        ...
        // Spigot start
        if (Bukkit.getServer().isActivationEntities() && !org.spigotmc.ActivationRange.checkIfActive(entity)) {
            entity.ticksLived++;
            entity.inactiveTick();
