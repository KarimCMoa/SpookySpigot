...
import eu.poliks.pspigot.tacospigot.potion.PotionEffectAddEvent;
import eu.poliks.pspigot.tacospigot.potion.PotionEffectExpireEvent;
import eu.poliks.pspigot.tacospigot.potion.PotionEffectExtendEvent;
import eu.poliks.pspigot.tacospigot.potion.PotionEffectRemoveEvent;
import eu.poliks.pspigot.KnockBack;
import eu.poliks.pspigot.util.CraftPotionUtil;
...
public abstract class EntityLiving extends Entity {
    ...
    public KnockBack getKnockbackProfile() {
        return knockbackProfile;
    }

    public void setKnockbackProfile(KnockBack profile) {
...
//                    flag = false;
    ...
    public void a(Entity entity, float f, double d0, double d1) {
        if (this.random.nextDouble() >= this.getAttributeInstance(GenericAttributes.c).getValue()) {
            this.ai = true;
            float f1 = (float) FastMath.sqrt(d0 * d0 + d1 * d1);
            float f2 = 0.4F;
            float f3 = 0.4F;

            KnockBack profile = this.getKnockbackProfile() == null ? Bukkit.getServer().getActiveKnockback() : this.getKnockbackProfile();
